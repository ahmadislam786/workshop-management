...
import { formatTimeFromLocal, formatDateShort } from "@/utils/formatting/utils";
...
export const TechnicianDashboard: React.FC = () => {
  ...
  const displayAppointments = showCompletedJobs
  ...
  const stats = {
    ...
    pendingJobs: technicianAppointments.filter(j => j.status === "waiting")
      .length,
                      ...
                      <div className="bg-white rounded-lg p-4 border border-gray-200 mb-4">
                        ...
                        {appointment.date && (
                          <div className="text-sm text-gray-600 mb-2">
                            <span>
                              Scheduled: {formatDateShort(appointment.date)} at{" "}
                              {formatTimeFromLocal(appointment.date)}
                            </span>
                          </div>
                        )}
                        {appointment.notes && (
                        ...
                        {appointment.aw_estimate && (
                          <div className="text-sm text-gray-600">
                            ...
                            {((appointment.aw_estimate * 6) / 60).toFixed(1)}{" "}
                            hours)
                          </div>
                        )}
                      </div>
